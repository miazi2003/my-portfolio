      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {isLoading && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((n) => (
              <div key={n} className="animate-pulse flex flex-col h-full bg-zinc-900/30 border border-white/5 rounded-2xl overflow-hidden">
                ...
                <div className="p-8 flex flex-col flex-grow space-y-4">
                  ...
                  <div className="h-10 bg-zinc-800/50 rounded-lg w-full mt-auto" />
                </div>
              </div>
            ))}
          </div>
