...
import { useBlogs } from "../../hooks/usePublicData";
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {isLoading && (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[1, 2, 3].map((n) => (
              <div key={n} className="animate-pulse flex flex-col h-full bg-zinc-900/30 border border-white/5 rounded-2xl overflow-hidden p-8 space-y-6">
                <div className="flex justify-between items-center">
                  <div className="h-6 bg-zinc-800/50 rounded w-1/3" />
                  <div className="h-4 bg-zinc-800/50 rounded w-1/4" />
                </div>
                <div className="space-y-3 flex-grow">
                  <div className="h-7 bg-zinc-800/50 rounded w-5/6" />
        ...
        {isError && <p className="text-center text-red-300">Failed to load articles.</p>}
              ...
              >
                ...
                <div className="p-8 relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-auto pt-6 border-t border-white/5 space-y-4">
                    ...
                    <Link
                      to={`/blogs/${blog.slug || blog.id || blog._id}`}
